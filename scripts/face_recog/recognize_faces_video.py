...
ap.add_argument("-o", "--outout", type=str, help="path to output video")
ap.add_argument("-y", "--display", type=int, default=1, help="wheter or not to display output frame to screen")
